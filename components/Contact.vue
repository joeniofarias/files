            ...
            <div class="contact-one__infos">
              <div class="contact-one__infos-single">
                ...
                <div class="contact-one__infos-content">
                  <h3>Addresss</h3>
                  <p>9370 SW 8th Street #312, City: Boca Raton, State: FLORIDA, Zipcode: 33428, Country: UNITED STATES <br> America </p>
              ...
              <div class="contact-one__infos-single">
                ...
                <div class="contact-one__infos-content">
                  <h3>Email</h3>
                  <p><a href="mailto:bestboxusa1@gmail.com">bestboxusa1@gmail.com</a></p>
                </div><!-- /.contact-one__infos-content -->
              </div><!-- /.contact-one__infos-single -->
              <div class="contact-one__infos-single">
                <div class="contact-one__infos-icon">
                ...
                <div class="contact-one__infos-content">
                  <h3>Phone</h3>
                  <p><a href="tel:5612551153">5612551153</a></p>
                </div><!-- /.contact-one__infos-content -->
              </div><!-- /.contact-one__infos-single -->
            ...
            <form action="" class="contact-form-validated contact-one__form">
              <div class="row">
                ...
                <div class="col-md-12">
                  ...
                  <button type="submit" class="thm-btn contact-one__form-btn">Envie Mensagem</button>
                </div><!-- /.col-md-12 -->
              </div><!-- /.row -->
