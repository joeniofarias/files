        ...
        <div class="col-lg-4 col-md-6">
          <div class="blog-one__single">
            ...
            <div class="blog-one__content">
              ...
              <nuxt-link to="/blog-details" class="blog-one__link"
        ...
        <div class="col-lg-4 col-md-6">
          <div class="blog-one__single">
            ...
            <div class="blog-one__content">
              ...
              <h3>
                <nuxt-link to="/blog-details"
                  >It is all exactly as i said, but i don't like it let's unpack
                  that</nuxt-link
                >
              </h3>
              <nuxt-link to="/blog-details" class="blog-one__link"
        ...
        <div class="col-lg-4 col-md-6">
          <div class="blog-one__single">
            ...
            <div class="blog-one__content">
              ...
              <h3>
                <nuxt-link to="/blog-details"
                  >Paddle on both sides cross functional teams enable
                  out</nuxt-link
                >
              </h3>
              <nuxt-link to="/blog-details" class="blog-one__link"
        ...
        <div class="col-lg-4 col-md-6">
          <div class="blog-one__single">
            ...
            <div class="blog-one__content">
              ...
              <h3>
                <nuxt-link to="/blog-details"
                  >A loss a day will keep you focus run it up the
                  flagpole</nuxt-link
                >
              </h3>
